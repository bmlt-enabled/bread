(function() {
	tinymce.PluginManager.add('front_page_button', function( editor, url ) { 
		editor.addButton( 'front_page_button', {
			...
			menu: [
					...
					menu: [
						{
							...
							editor.windowManager.open({
								...
								url: 'http://nameetinglist.org/videos/nameetinglist.mp4',
								width: 800,
								height: 600,
								buttons: [{
									text: 'Close',
						...
						},
						{
							...
							editor.windowManager.open({
								title: 'Shortcode Instructions',
								url: 'http://nameetinglist.org/videos/table.html',
								width: 650,
								height: 530,
								buttons: [{
									text: 'Close',
				...
				},
				{
					...
					menu: [
						...
						},
						{
							...
							onclick: function() {
								editor.insertContent('<table style="width: 100%;"><tbody><tr><td style="padding: 2pt; text-align: center; background-color: #000000;"><strong><span style="color: #fff;">Reunión Formato Leyenda</span></strong></td></tr></tbody></table><p>[format_codes_used_basic_es]</p>');
							}
						},
						{
						...
						},
						{
							...
							onclick: function() {
								editor.insertContent('<table style="width: 100%;"><tbody><tr><td style="padding: 2pt; text-align: center; background-color: #000000;"><strong><span style="color: #fff;">Reunión Formato Leyenda</span></strong></td></tr></tbody></table><p>[format_codes_used_detailed_es]</p>');
							}
						},
						{
				...
				},
				{
					...
					onclick: function() {
						editor.insertContent('<table style="width: 100%;"><tbody><tr><td style="padding: 2pt; text-align: center; background-color: #000000;"><strong><span style="color: #fff;">Service Meetings</span></strong></td></tr></tbody></table><p>[service_meetings]</p>');
					}
				},
				{
					text: 'Service Body',
				...
				},
				{
					text: 'Date',
					menu: [
						{							text: 'Month (UPPER CASE)',							onclick: function() {								editor.insertContent('[month_upper]');							}						},						{							text: 'Month (Lower Case)',							onclick: function() {								editor.insertContent('[month_lower]');							}						},						{							text: 'Month French (UPPER CASE)',							onclick: function() {								editor.insertContent('[month_upper_fr]');							}						},						{							text: 'Month French (Lower Case)',							onclick: function() {								editor.insertContent('[month_lower_fr]');							}						},						{							text: 'Month Spanish (UPPER CASE)',							onclick: function() {								editor.insertContent('[month_upper_es]');							}						},						{							text: 'Month Spanish (Lower Case)',							onclick: function() {								editor.insertContent('[month_lower_es]');							}						},						{
							text: 'Day',
							onclick: function() {
		...
		editor.addButton( 'custom_template_button_1', {
			...
			menu: [
				{
					...
					onclick: function() {
						editor.insertContent('<table style="width: 100%; padding: 0;" cellspacing="0" cellpadding="1"><tbody><tr><td style="border-bottom: 1px solid #dddddd; vertical-align: top;"><strong>time group</strong>, location, info, street, city, state, zip (formats) <em>comments</em></td></tr></tbody></table>');
					}
				},
				{
					text: 'Two Column Template [Time] [Meeting Data]',
					onclick: function() {
						editor.insertContent('<table style="width: 100%; padding: 0;" cellspacing="0" cellpadding="1"><tbody><tr><td style="width: 15%; border-bottom: 1px solid #dddddd; vertical-align: top; text-align: center;"><strong>time</strong></td><td style="border-bottom: 1px solid #dddddd; vertical-align: top;">group</strong>, location, info, street, city, state, zip (formats) <em>comments</em></strong></td></tr></tbody></table>');
					}
				},
				{
					text: 'Three Column Template [Day] [Time] [Meeting Data]',
					onclick: function() {
						editor.insertContent('<table style="width: 100%; padding: 0;" cellspacing="0" cellpadding="1"><tbody><tr><td style="width: 4%; border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #dddddd; vertical-align: top; text-align: center;"><strong>day_abbr</strong></td><td style="width: 8%; border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #dddddd; vertical-align: top; text-align: center;"><strong>time</strong></td><td style="border-bottom: 1px solid #dddddd; vertical-align: top;"><strong>group</strong>, location, info, street, city, state, zip (formats) <em>comments</em></td></tr></tbody></table>');
					}
				}
			]
		});	
		editor.addButton( 'custom_template_button_2', {
			...
			menu: [
				...
				},
				{
					...
					menu: [
						...
						{
							text: 'Bus Line (bus_line)',
							onclick: function() {
								editor.insertContent('bus_line');
							}
						},
						{
							text: 'City (city)',
						...
						{							text: 'Neighborhood (neighborhood)',							onclick: function() {								editor.insertContent('neighborhood');							}						},						{							text: 'State (state)',							onclick: function() {								editor.insertContent('state');							}						},						{
							text: 'Zip Code (zip)',
							onclick: function() {
