        ...
        <div id="normal-sortables" class="meta-box-sortables ui-sortable">
            <div id="exportdiv" class="postbox">
                ...
                <div class="inside">
                    ...
                    <form method="post">
                        <p><?php esc_html_e('Meeting List ID: ', 'bread') ?><?php echo esc_html($this->bread->getRequestedSetting()) ?>
                        ...
                        <br><?php esc_html_e('Configuration Name: ', 'bread') ?><input type="text" name="setting_descr" value="<?php echo esc_attr($this->bread->getSettingName($this->bread->getRequestedSetting())) ?>" />
