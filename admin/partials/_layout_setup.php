            ...
            <div id="pagelayoutdiv" class="postbox">
                ...
                <div class="inside">
                    ...
                    <div>
                        ...
                        <input class="mlg single-page" id="pocket" type="radio" name="page_size" value="pocket" <?php echo ($bread->getOption('page_size') == 'pocket' ? 'checked' : '') ?>><label for="pocket" class="single-page"><?php esc_html_e('Pocket', 'bread') ?>&nbsp;&nbsp;&nbsp;</label>
                        ...
                        <div id="marginsdiv" style="border-top: 1px solid #EEE;">
                            ...
                            <?php esc_html_e('Left: ', 'bread') ?><input min="0" max="20" step="1" size="3" maxlength="3" type="number" class="bmlt-input-field" style="display:inline;" id="margin_left" name="margin_left" value="<?php echo esc_attr($bread->getOptionForDisplay('margin_left', '3')); ?>" />&nbsp;&nbsp;&nbsp;
                            <?php esc_html_e('Right: ', 'bread') ?><input min="0" max="20" step="1" size="3" maxlength="3" type="number" class="bmlt-input-field" style="display:inline;" id="margin_right" name="margin_right" value="<?php echo esc_attr($bread->getOptionForDisplay('margin_right', '3')); ?>" />&nbsp;&nbsp;&nbsp;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="postbox">
                ...
                <div class="inside">
                    <div id="watermarkandheaderdiv" style="border-top: 1px solid #EEE;" class="single-page">
                        ...
                        <br />
                        <label for="pageheader_fontsize"><?php esc_html_e('Font Size: ', 'bread') ?></label><input min="4" max="40" step=".1" size="3" maxlength="3" type="number" class="bmlt-input-field" style="display:inline;" id="pageheader_fontsize" name="pageheader_fontsize" value="<?php echo esc_attr($bread->getOption('pageheader_fontsize')); ?>" />
                        <label for="pageheader_textcolor" style="margin-left:10px;"><?php esc_html_e('Text Color:', 'bread') ?></label> <input style="display: inline-block !important; width: 70px; margin-right: 5px;" type='color' class="bmlt_color" id="pageheader_textcolor" name="pageheader_textcolor" value="<?php echo esc_attr($bread->getOption('pageheader_textcolor')); ?>" />
                        ...
                        <?php esc_html_e('Header Margin Top: ', 'bread') ?><input min="0" max="20" step="1" size="3" maxlength="3" type="number" class="bmlt-input-field" style="display:inline;" id="margin_header" name="margin_header" value="<?php echo esc_attr($bread->getOption('margin_header')); ?>" />&nbsp;&nbsp;&nbsp;
                        <br><?php esc_html_e('Header Text: ', 'bread') ?><input size="100" type="text" id="pageheader_content" name="pageheader_content" value="<?php echo esc_attr($bread->getOptionForDisplay('pageheader_content', '')); ?>" />&nbsp;&nbsp;&nbsp;
                        <br><?php esc_html_e('Watermark: ', 'bread') ?><input size="100" type="text" id="watermark" name="watermark" autocomplete="off" value="<?php echo esc_url($bread->getOptionForDisplay('watermark', '')); ?>" />&nbsp;&nbsp;&nbsp;
                    </div>
                    ...
                    <div id="pagenodiv" style="border-top: 1px solid #EEE;" class="booklet">
                        <?php esc_html_e('Page Numbers Font Size: ', 'bread') ?><input min="1" max="20" step="1" size="3" maxlength="3" type="number" class="bmlt-input-field" style="display:inline;" id="pagenumbering_font_size" name="pagenumbering_font_size" value="<?php echo esc_attr($bread->getOptionForDisplay('pagenumbering_font_size', '9')); ?>" />
                    </div>
