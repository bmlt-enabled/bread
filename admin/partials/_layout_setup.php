...
<div id="poststuff">
            ...
            <div id="pagelayoutdiv" class="postbox">
                ...
                <div class="inside">
                    ...
                    <div>
                        ...
                        <input class="mlg booklet" id="A6" type="radio" name="page_size" value="A6" <?php echo (Bread::getOption('page_size') == 'A6' ? 'checked' : '') ?>><label for="A6" class="booklet">A6&nbsp;&nbsp;&nbsp;</label>
    ...
    <div class="postbox-container">
        <div class="meta-box-sortables ui-sortable">
            <div class="postbox">
                <div style="display:none;">
                    <div id="pagedeco-tooltip-content"><p>
                        Describes things on the page other than the contents.  Headers, footers, page numbers.
                        <br/>What options you see will be dependant on the layout selected.</p>
                    </div>
                </div>
                ...
                <div class="inside">
                    <div id="watermarkandheaderdiv" style="border-top: 1px solid #EEE;" class="single-page">
                            ...
                            <label for="pageheader_textcolor" style="margin-left:10px;">Text Color:</label> <input style="display: inline-block !important; width: 70px; margin-right: 5px;" type='color' class="bmlt_color" id="pageheader_textcolor" name="pageheader_textcolor" value="<?php echo Bread::getOption('pageheader_textcolor'); ?>" />
                            <label for="pageheader_backgroundcolor" style="margin-left:10px;">Background Color:</label> <input style="display: inline-block !important; width: 70px; margin-right: 5px;" type='color' id="pageheader_backgroundcolor" class="bmlt_color" name="pageheader_backgroundcolor" value="<?php echo Bread::getOption('pageheader_backgroundcolor'); ?>" />
                    ...
                    <div id="columnseparatordiv" style="border-top: 1px solid #EEE;" class="single-page">
                                ...
                                <label for="col_color">Color:</label> <input style="display: inline-block !important; width: 70px; margin-right: 5px;" type='color' class="bmlt-color" id="col_color" name="col_color" value="<?php echo Bread::getOptionForDisplay('col_color', '#bfbfbf'); ?>" />
                    </div>
                </div>
            </div>
        </div>
