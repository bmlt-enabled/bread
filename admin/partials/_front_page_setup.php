...
function Bread_front_page_setup_page_render(Bread_AdminDisplay $breadAdmin)
{
    ...
    <div id="postbox-container" class="postbox-container">
        <div id="normal-sortables" class="meta-box-sortables ui-sortable">
            <div id="frontpagecontentdiv" class="postbox">
                ...
                <div class="inside">
                    <p><?php esc_html_e('Default Font Size: ', 'bread') ?><input min="4" max="18" step=".1" size="3" maxlength="3" type="number" class="bmlt-input-field" style="display:inline;" id="front_page_font_size" name="front_page_font_size" value="<?php echo esc_attr($bread->getOptionForDisplay('front_page_font_size', '10')); ?>" />&nbsp;&nbsp;
                        <?php esc_html_e('Line Height: ', 'bread') ?><input min="1" max="3" step=".1" size="3" maxlength="3" type="number" class="bmlt-input-field" style="display:inline;" id="front_page_line_height" type="text" maxlength="3" size="3" name="front_page_line_height" value="<?php echo esc_attr($bread->getOptionForDisplay('front_page_line_height', '1.0')); ?>" /></p>
