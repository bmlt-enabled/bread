    ...
    <div id="postbox-container" class="postbox-container">
        <div id="normal-sortables" class="meta-box-sortables ui-sortable">
                ...
                <div class="inside">
                    <div>
                        ...
                        <table id="header_options_div">
                            <tr>
                                <td style="padding-right: 10px;">Font Size: <input min="4" max="18" step=".1" size="3" maxlength="3" type="number" class="bmlt-input-field" style="display:inline;" id="header_font_size" name="header_font_size" value="<?php echo esc_attr($bread->getOption('header_font_size')); ?>" /></td>
                                <td style="padding-right: 10px;">
                                    <div class="theme" id="sp-light">
                                        <label for="header_text_color">Text Color:</label> <input style="display: inline-block !important; width: 70px; margin-right: 5px;" type='color' id="header_text_color" class="bmlt_color" name="header_text_color" value="<?php echo esc_attr($bread->getOption('header_text_color')); ?>" />
                                    </div>
                                </td>
                                <td style="padding-right: 10px;">
                                    <div class="theme" id="sp-light">
                                        <label for="header_background_color">Background Color:</label> <input style="display: inline-block !important; width: 70px; margin-right: 5px;" type='color' id="header_background_color" class="bmlt_color" name="header_background_color" value="<?php echo esc_attr($bread->getOption('header_background_color')); ?>" />
                                    </div>
                                </td>
                                <td style="padding-right: 10px;">
                    ...
                    <div class="group_by" style="margin-right: 10px; display: inline;">
                        ...
                        <select id="meeting_sort" name="meeting_sort">
                            <option <?php echo ($bread->getOption('meeting_sort') == 'day' ? 'selected' : '') ?> value="day">Weekday</option>
                            <option <?php echo ($bread->getOption('meeting_sort') == 'city' ? 'selected' : '') ?> value="city">City</option>
                            <option <?php echo ($bread->getOption('meeting_sort') == 'group' ? 'selected' : '') ?> value="group">Group</option>
                            <option <?php echo ($bread->getOption('meeting_sort') == 'county' ? 'selected' : '') ?> value="county">County</option>
                            <option <?php echo ($bread->getOption('meeting_sort') == 'borough' ? 'selected' : '') ?> value="borough">Borough</option>
                            <option <?php echo ($bread->getOption('meeting_sort') == 'borough_county' ? 'selected' : '') ?> value="borough_county">Borough+County</option>
                            <option <?php echo ($bread->getOption('meeting_sort') == 'neighborhood_city' ? 'selected' : '') ?> value="neighborhood_city">Neighborhood+City</option>
                            <option <?php echo ($bread->getOption('meeting_sort') == 'state' ? 'selected' : '') ?> value="state">State+City</option>
                            <option <?php echo ($bread->getOption('meeting_sort') == 'weekday_area' ? 'selected' : '') ?> value="weekday_area">Weekday+Area</option>
                            <option <?php echo ($bread->getOption('meeting_sort') == 'weekday_city' ? 'selected' : '') ?> value="weekday_city">Weekday+City</option>
                            <option <?php echo ($bread->getOption('meeting_sort') == 'weekday_county' ? 'selected' : '') ?> value="weekday_county">Weekday+County</option>
                            <option <?php echo ($bread->getOption('meeting_sort') == 'user_defined' ? 'selected' : '') ?> value="user_defined">User Defined</option>
                        </select>
                    </div>
                    ...
                    <div class="user_defined_headings">
                        <p>
                            ...
                            <select id="main_grouping" name="main_grouping">
                                <option <?php echo ($bread->getOption('main_grouping') == 'day' ? 'selected' : '') ?> value="day">Weekday</option>
                                <option <?php echo ($bread->getOption('main_grouping') == 'location_municipality' ? 'selected' : '') ?> value="location_municipality">City</option>
                                <option <?php echo ($bread->getOption('main_grouping') == 'location_neighborhood' ? 'selected' : '') ?> value="location_neighborhood">Neighborhood</option>
                                <option <?php echo ($bread->getOption('main_grouping') == 'group' ? 'selected' : '') ?> value="group">Group</option>
                                <option <?php echo ($bread->getOption('main_grouping') == 'location_sub_province' ? 'selected' : '') ?> value="location_sub_province">County</option>
                                <option <?php echo ($bread->getOption('main_grouping') == 'location_city_subsection' ? 'selected' : '') ?> value="location_city_subsection">Borough</option>
                                <option <?php echo ($bread->getOption('main_grouping') == 'location_province' ? 'selected' : '') ?> value="location_province">State</option>
                                <?php
                            ...
                            <select id="subgrouping" name="subgrouping">
                                <option <?php echo (empty($bread->getOption('subgrouping')) ? 'selected' : '') ?> value="">None</option>
                                <option <?php echo ($bread->getOption('subgrouping') == 'day' ? 'selected' : '') ?> value="day">Weekday</option>
                                <option <?php echo ($bread->getOption('subgrouping') == 'location_municipality' ? 'selected' : '') ?> value="location_municipality">City</option>
                                <option <?php echo ($bread->getOption('subgrouping') == 'location_neighborhood' ? 'selected' : '') ?> value="location_neighborhood">Neighborhood</option>
                                <option <?php echo ($bread->getOption('subgrouping') == 'group' ? 'selected' : '') ?> value="group">Group</option>
                                <option <?php echo ($bread->getOption('subgrouping') == 'location_sub_province' ? 'selected' : '') ?> value="location_sub_province">County</option>
                                <option <?php echo ($bread->getOption('subgrouping') == 'location_city_subsection' ? 'selected' : '') ?> value="location_city_subsection">Borough</option>
                                <option <?php echo ($bread->getOption('subgrouping') == 'location_province' ? 'selected' : '') ?> value="location_province">State</option>
                                <?php
                                foreach ($fks as $fk) {
                                    $selected = '';
            ...
            <div id="custommeetingtemplatediv" class="postbox">
                ...
                <div class="inside">
                    <p>
                        Default Font Size: <input min="4" max="18" step=".1" size="3" maxlength="3" type="number" class="bmlt-input-field" style="display:inline;" id="content_font_size" name="content_font_size" value="<?php echo esc_attr($bread->getOption('content_font_size')); ?>" />&nbsp;&nbsp;
                        Line Height: <input min="1" max="3" step=".1" size="3" maxlength="3" type="number" class="bmlt-input-field" style="display:inline;" id="content_line_height" type="text" maxlength="3" size="3" name="content_line_height" value="<?php echo esc_attr($bread->getOption('content_line_height')); ?>" />&nbsp;&nbsp;
                        Wheelchair Icon Size: <input size="5" maxlength="10" class="bmlt-input-field" style="display:inline;" id="wheelchair_size" type="text" name="wheelchair_size" value="<?php echo esc_attr($bread->getOption('wheelchair_size')); ?>" />&nbsp;&nbsp;
