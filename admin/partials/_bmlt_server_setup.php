            ...
            <div id="bmltrootserverurl" class="postbox">
                ...
                <div class="inside">
                    ...
                    <?php if ($this_connected) { ?>
                        <?php $unique_areas = Bread_Bmlt::get_areas(); ?>
                        ...
                        <li>
                            ...
                            <?php if ($this_connected) { ?>
                                ...
                                <?php foreach ($unique_areas as $unique_area) { ?>
                                    ...
                                    <?php $area_name = $this->admin->arraySafeGet($area_data); ?>
                                    <?php $area_id = $this->admin->arraySafeGet($area_data, 1); ?>
                                    <?php $area_parent = $this->admin->arraySafeGet($area_data, 2); ?>
                                    <?php $area_parent_name = $this->admin->arraySafeGet($area_data, 3); ?>
                                    <?php $option_description = $area_name . " (" . $area_id . ") " . $area_parent_name . " (" . $area_parent . ")" ?>
                                    <?php $is_data = explode(',', esc_html(Bread::getOption('service_body_1'))); ?>
                                    <?php if ($this->admin->arraySafeGet($is_data) != "Not Used" && $area_id == $this->admin->arraySafeGet($is_data, 1)) { ?>
                                ...
                                <?php } ?>
                            <?php } else { ?>
                                <option selected="selected" value="<?php echo esc_html(Bread::getOption('service_body_1')); ?>"><?php echo 'Not Connected - Can not get Service Bodies'; ?></option>
                            <?php } ?>
                            </select>
                        </li>
                        <li>
                            ...
                            <?php if ($this_connected) { ?>
                                ...
                                <?php foreach ($unique_areas as $unique_area) { ?>
                                    ...
                                    <?php $is_data = explode(',', esc_html(Bread::getOption('service_body_2'))); ?>
                                    <?php if ($this->admin->arraySafeGet($is_data) != "Not Used" && $area_id == $this->admin->arraySafeGet($is_data, 1)) { ?>
                                        <option selected="selected" value="<?php echo $unique_area ?>"><?php echo $option_description ?></option>
                                    <?php } else { ?>
                                        <option value="<?php echo $unique_area ?>"><?php echo $option_description ?></option>
                                ...
                                <?php } ?>
                            <?php } else { ?>
                                <option selected="selected" value="<?php echo esc_html(Bread::getOption('service_body_2')); ?>"><?php echo 'Not Connected - Can not get Service Bodies'; ?></option>
                            <?php } ?>
                            </select>
                        </li>
                        <li>
                            ...
                            <?php if ($this_connected) { ?>
                                ...
                                <?php foreach ($unique_areas as $unique_area) { ?>
                                    ...
                                    <?php $area_parent_name = $this->admin->arraySafeGet($area_data, 3); ?>
                                    <?php $option_description = $area_name . " (" . $area_id . ") " . $area_parent_name . " (" . $area_parent . ")" ?></option>
                                    <?php $is_data = explode(',', esc_html(Bread::getOption('service_body_3'))); ?>
                                    <?php if ($this->admin->arraySafeGet($is_data) != "Not Used" && $area_id == $this->admin->arraySafeGet($is_data, 1)) { ?>
                                        <option selected="selected" value="<?php echo $unique_area ?>"><?php echo $option_description ?></option>
                                    <?php } else { ?>
                                        <option value="<?php echo $unique_area ?>"><?php echo $option_description ?></option>
                                ...
                                <?php } ?>
                            <?php } else { ?>
                                <option selected="selected" value="<?php echo esc_html(Bread::getOption('service_body_3')); ?>"><?php echo 'Not Connected - Can not get Service Bodies'; ?></option>
                            <?php } ?>
                            </select>
                        </li>
                        <li>
                            ...
                            <?php if ($this_connected) { ?>
                                ...
                                <?php foreach ($unique_areas as $unique_area) { ?>
                                    ...
                                    <?php $area_parent_name = $this->admin->arraySafeGet($area_data, 3); ?>
                                    <?php $option_description = $area_name . " (" . $area_id . ") " . $area_parent_name . " (" . $area_parent . ")" ?></option>
                                    <?php $is_data = explode(',', esc_html(Bread::getOption('service_body_4'))); ?>
                                    <?php if ($this->admin->arraySafeGet($is_data) != "Not Used" && $area_id == $this->admin->arraySafeGet($is_data, 1)) { ?>
                                        <option selected="selected" value="<?php echo $unique_area ?>"><?php echo $option_description ?></option>
                                    <?php } else { ?>
                                        <option value="<?php echo $unique_area ?>"><?php echo $option_description ?></option>
                                ...
                                <?php } ?>
                            <?php } else { ?>
                                <option selected="selected" value="<?php echo esc_html(Bread::getOption('service_body_4')); ?>"><?php echo 'Not Connected - Can not get Service Bodies'; ?></option>
                            <?php } ?>
                            </select>
                        </li>
                        <li>
                            ...
                            <?php if ($this_connected) { ?>
                                ...
                                <?php foreach ($unique_areas as $unique_area) { ?>
                                    ...
                                    <?php $area_parent_name = $this->admin->arraySafeGet($area_data, 3); ?>
                                    <?php $option_description = $area_name . " (" . $area_id . ") " . $area_parent_name . " (" . $area_parent . ")" ?></option>
                                    <?php $is_data = explode(',', esc_html(Bread::getOption('service_body_5'))); ?>
                                    <?php if ($this->admin->arraySafeGet($is_data) != "Not Used" && $area_id == $this->admin->arraySafeGet($is_data, 1)) { ?>
                                        <option selected="selected" value="<?php echo $unique_area ?>"><?php echo $option_description ?></option>
                                    <?php } else { ?>
                                        <option value="<?php echo $unique_area ?>"><?php echo $option_description ?></option>
                                ...
                                <?php } ?>
                            <?php } else { ?>
                                <option selected="selected" value="<?php echo esc_html(Bread::getOption('service_body_5')); ?>"><?php echo 'Not Connected - Can not get Service Bodies'; ?></option>
                            <?php } ?>
                            </select>
                        </li>
                    </ul>
