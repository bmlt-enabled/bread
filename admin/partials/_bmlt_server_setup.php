                ...
                <div class="inside">
                    ...
                    if ($breadAdmin->isConnected()) {
                        ...
                        ?><span style='color: #f00;'>
                            <div style='font-size: 16px;vertical-align: middle;' class='dashicons dashicons-dismiss'></div>ERROR: Problem Connecting to BMLT Server<br /><?php echo esc_html($bread->bmlt()->connection_error); ?>
                        </span>
                        <p>
                ...
                <div style="display:none;">
                    <div id="customquery-tooltip-content">
                        <p>
                            ...
                            <br />You can get help formulating a query using your sites <a href="<?php echo esc_url($bread->getOption('root_server')); ?>/semantic">semantic interface</a>.
                        </p>
                    </div>
                </div>
            ...
            <div id="extrameetingsdiv" class="postbox">
                ...
                <div class="inside">
                    ...
                    if ($bread->getOption('extra_meetings_enabled') == 0) {
                        echo 'Not Enabled';
                    } elseif (!$breadAdmin->isConnected()) {
                        echo 'Not Connected';
                    } else {
                        echo 'Select Extra Meetings';
                    } ?>" id="extra_meetings" name="extra_meetings[]" multiple="multiple">
                        <?php
                        if ($breadAdmin->isConnected() && $bread->getOption('extra_meetings_enabled') == 1) {
