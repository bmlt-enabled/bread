...
= 2.10.7 =
* Allow fields added through extenstions to be used as groupings
...
= 2.10.2 =
* Eliminate array-out-of-bounds warning when custom-query used.
* Add description of shortcode to admin page.
